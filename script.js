...
<label class="order__title" for="fio">ФИО или организация:</label>
<input class="order__input" type="text" id="fio" name="fio" placeholder="Напр.: Алексей" value="">

<label class="order__title" for="phone">Телефон:</label>
<input class="order__input" type="tel" id="tel" name="phone" placeholder="+7 (___) ___-__-__" value="">

<p class="order__text">Отправляя данные, Вы соглашаетесь c <a href="#" class="order__link">Правилами обработки персональных данных</a></p>

</div>
`;

this.insertAdjacentHTML('beforebegin', menuHTML);
formVisible = true;
...
// Добавляем обработчики событий для маскировки
